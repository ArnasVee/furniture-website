...
function updateNextProjectLink() {
    ...
    nextProjectLink.href = `/jauna-reklama-boruna/html/vienasProjektas.html?projectTitle=${encodeURIComponent(nextProjectTitle)}`;
}
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  function renderContentCards() {
    ...
    for (let i = startIndex; i < endIndex && i < filteredProjects.length; i++) {
        ...
        contentCardsHTML += `
            <a href="/jauna-reklama-boruna/html/vienasProjektas.html?projectTitle=${encodeURIComponent(project.title)}" class="content-card">
